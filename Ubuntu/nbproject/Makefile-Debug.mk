...
${TESTDIR}/tests/MoreExamples.o: tests/MoreExamples.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/MoreExamples.o tests/MoreExamples.cpp


${TESTDIR}/tests/VCLTests.o: tests/VCLTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/VCLTests.o tests/VCLTests.cpp
