...
Some came close, and I resisted for a while, but I could not find any existing code that gave me the ability to 'just write it'. I hope that is what is acheived in @quick_unit@ and that it is so easy to use that no-one will have an excuse to skip their tests.
