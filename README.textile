...
<pre><code>====================================================
Starting My First Tests at Mon Jun nn hh:mm:ss yyyy
...
----------------------------------------------------
Finished My First Tests at Mon Jun nn hh:mm:ss yyyy
Passes: 1 Fails: 2
----------------------------------------------------

====================================================
Starting Compiler Tests at Mon Jun nn hh:mm:ss yyyy

Test: Compiler checks => OK.

----------------------------------------------------
Finished Compiler Tests at Mon Jun nn hh:mm:ss yyyy
Passes: 1 Fails: 0
----------------------------------------------------
</code></pre>
